...
def vad_TwoThr(x, wlen, inc, NIS):
    ...
    amp2 = 2 * ampth                 ##amp1,amp2分别为双门限的上下限,zcr2是过零率
    amp1 = 4 * ampth
    zcr2 = 2 * zcrth
    xn = 0
    count = np.zeros(fn)
...
# 定义要创建的目录
mkpath = "D:\\VAD_python_threhold\\Example_Try3.2\\Data_predict\\"
# 调用函数
mkdir(mkpath)

#####################################################################################################

base='D:\VAD_python_threhold\Example_Try3.2\Example_LastTry3\data_sheet'
